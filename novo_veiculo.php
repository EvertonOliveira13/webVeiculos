...
<html lang="en">
  <head>
    ...
    <link href="css/cssCadastroConsulta.css" rel="stylesheet" type="text/css">
    <title>Add veiculo</title>
...
<h1>Add veiculo</h1>
    <form action="./novo_veiculo.php?incluir" method="POST" enctype="multipart/form-data">
      <table>
        ...
        <tr><td><a href='index.php'>Voltar</a> <br><input type="submit" value="Salvar"></td></tr>
      </table>
    </form>
  </body>
</html>